...
class Ps_FeaturedProducts_2 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->trans('Featured products 2', [], 'Modules.Featuredproducts.Admin');
        ...
        $this->templateFile = 'module:ps_featuredproducts_2/views/templates/hook/ps_featuredproducts_2.tpl';
    }
    ...
    public function install()
    {
        ...
        Configuration::updateValue('HOME_FEATURED_2_NBR', 8);
        Configuration::updateValue('HOME_FEATURED_2_CAT', (int) Context::getContext()->shop->getCategory());
        Configuration::updateValue('HOME_FEATURED_2_RANDOMIZE', false);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitHomeFeatured')) {
            ...
            if (count($errors)) {
                ...
                Configuration::updateValue('HOME_FEATURED_2_NBR', (int) $nbr);
                Configuration::updateValue('HOME_FEATURED_2_CAT', (int) $cat);
                Configuration::updateValue('HOME_FEATURED_2_RANDOMIZE', (bool) $rand);
    ...
    {
        return [
            'HOME_FEATURED_2_NBR' => Tools::getValue('HOME_FEATURED_2_NBR', (int) Configuration::get('HOME_FEATURED_2_NBR')),
            'HOME_FEATURED_2_CAT' => Tools::getValue('HOME_FEATURED_2_CAT', (int) Configuration::get('HOME_FEATURED_2_CAT')),
            'HOME_FEATURED_2_RANDOMIZE' => Tools::getValue('HOME_FEATURED_2_RANDOMIZE', (bool) Configuration::get('HOME_FEATURED_2_RANDOMIZE')),
        ];
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (!empty($products)) {
            return [
                'products' => $products,
                'allProductsLink' => Context::getContext()->link->getCategoryLink($this->getConfigFieldsValues()['HOME_FEATURED_2_CAT']),
            ];
        }
    ...
    {
        $category = new Category((int) Configuration::get('HOME_FEATURED_2_CAT'));
        ...
        $nProducts = Configuration::get('HOME_FEATURED_2_NBR');
        if ($nProducts < 0) {
            $nProducts = 12;
        }
        ...
        if (Configuration::get('HOME_FEATURED_2_RANDOMIZE')) {

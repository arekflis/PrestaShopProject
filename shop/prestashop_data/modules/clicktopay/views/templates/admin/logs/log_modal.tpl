    ...
    <div class="log-modal-title">
      <h4>
          {if $log_information_type === 'request'}
              {$log_id|escape:'htmlall':'UTF-8'}: {l s='Request data' mod='clicktopay'}
          {elseif $log_information_type === 'response'}
              {$log_id|escape:'htmlall':'UTF-8'}: {l s='Response data' mod='clicktopay'}
          {elseif $log_information_type === 'context'}
              {$log_id|escape:'htmlall':'UTF-8'}: {l s='Context data' mod='clicktopay'}
          {/if}
      </h4>
    </div>

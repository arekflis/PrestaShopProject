...
class Ps_FeaturedProducts_3 extends Module implements WidgetInterface
{
    private $templateFile;

    public function __construct()
    {
        $this->name = 'ps_featuredproducts_3';
        ...
        $this->displayName = $this->trans('Featured products 3', [], 'Modules.Featuredproducts.Admin');
        ...
        $this->templateFile = 'module:ps_featuredproducts_3/views/templates/hook/ps_featuredproducts_3.tpl';
    }
    ...
    public function install()
    {
        ...
        Configuration::updateValue('HOME_FEATURED_3_NBR', 8);
        Configuration::updateValue('HOME_FEATURED_3_CAT', (int) Context::getContext()->shop->getCategory());
        Configuration::updateValue('HOME_FEATURED_3_RANDOMIZE', false);
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitHomeFeatured')) {
            ...
            if (count($errors)) {
                ...
                Configuration::updateValue('HOME_FEATURED_3_NBR', (int) $nbr);
                Configuration::updateValue('HOME_FEATURED_3_CAT', (int) $cat);
                Configuration::updateValue('HOME_FEATURED_3_RANDOMIZE', (bool) $rand);
    ...
    {
        return [
            'HOME_FEATURED_3_NBR' => Tools::getValue('HOME_FEATURED_3_NBR', (int) Configuration::get('HOME_FEATURED_3_NBR')),
            'HOME_FEATURED_3_CAT' => Tools::getValue('HOME_FEATURED_3_CAT', (int) Configuration::get('HOME_FEATURED_3_CAT')),
            'HOME_FEATURED_3_RANDOMIZE' => Tools::getValue('HOME_FEATURED_3_RANDOMIZE', (bool) Configuration::get('HOME_FEATURED_3_RANDOMIZE')),
        ];
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        if (!empty($products)) {
            return [
                'products' => $products,
                'allProductsLink' => Context::getContext()->link->getCategoryLink($this->getConfigFieldsValues()['HOME_FEATURED_3_CAT']),
            ];
        }
    ...
    {
        $category = new Category((int) Configuration::get('HOME_FEATURED_3_CAT'));
        ...
        $nProducts = Configuration::get('HOME_FEATURED_3_NBR');
        if ($nProducts < 0) {
            $nProducts = 12;
        }
        ...
        if (Configuration::get('HOME_FEATURED_3_RANDOMIZE')) {

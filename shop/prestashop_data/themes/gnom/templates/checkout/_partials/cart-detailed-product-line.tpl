...
<div class="basket__item --photo">
  <a class="photo__link" href="{$product.url}">
    <picture>
      <img class="photo__image" src="{$product.default_image.bySize.cart_default.url}" alt="{$product.name|escape:'quotes'}">
    </picture>
  </a>
</div>
...
<div class="basket__item --prices">
  <span class="basket__price">{$product.price}</span>
</div>

<div class="basket__item --sum">
  <span class="basket__sum">{$product.total}</span>
</div>
...
<div class="basket__item --actions">
  ...
  <div class="basket__action --calculate">
    <button onclick="refreshPage()" class="basket__calculate --button --submit" type="submit" title="zmień ilość">
  ...
  <div class="basket__action --remove">
    ...
    <a
              ...
              >
                {if empty($product.is_gift)}
                  <span id="cart-cross" class="material-symbols-outlined">close</span>
                {/if}
              </a>
    </div>
  </div>
